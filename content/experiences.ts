...
export const experiences: Experience[] = [
  {
    ...
    highlights: ["Bluetooth stereo", "Built-in cooler", "Shade canopy", "Captain included", "Up to 12 guests"],
  ...
  },
  {
    ...
    description:
      "Family-focused rental with calm coves, tubing, and swimming. Life vests for all ages. Captain included so parents can relax.",
    highlights: ["Kid-friendly", "Life vests all sizes", "Calm coves", "Captain included", "Up to 10"],
    duration: "4 hours",
    durationMinutes: 240,
    capacity: "Up to 10",
    heroImage: "/photos/DSC00544.webp",
    gallery: ["/photos/DSC00544.webp", "/photos/DSC00597.webp"],
    pricingNote: "From $349 for 4 hours.",
    faqs: [],
  },
  {
    slug: "corporate",
  ...
  },
  {
    ...
    highlights: ["Party-ready boats", "Captain included", "Decor add-ons", "Up to 14"],
