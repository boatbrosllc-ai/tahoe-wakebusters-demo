    ...
    <section className="section-padding bg-brand-bg" aria-labelledby="gallery-heading">
      <div className="container-wide">
        ...
        <p className="mt-6 sm:mt-6 text-center">
          ...
          >
            See all experiences
            <span className="inline-block group-hover:translate-x-0.5 transition-transform duration-200" aria-hidden>→</span>
          </Link>
        </p>
      </div>

      {/* Lightbox – works for both wide and vertical images */}
      <AnimatePresence>
        {lightboxSrc && (
          <motion.div
            initial={{ opacity: 0 }}
