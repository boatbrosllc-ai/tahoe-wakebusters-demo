...
export function Header() {
  ...
  return (
    ...
    >
      <div className="container-wide flex h-14 lg:h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center justify-start min-w-0">
          ...
          >
            <Image
              ...
              width={56}
              height={56}
              className="h-11 w-11 object-contain lg:h-12 lg:w-12 rounded-xl"
              priority
            />
          </Link>
        </div>
        ...
        <div className="flex flex-1 justify-end items-center gap-1 min-w-0">
          ...
          >
            <Calendar className="h-6 w-6 lg:h-5 lg:w-5" aria-hidden />
          </button>
